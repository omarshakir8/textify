  ...
  return (
    <div>
      ...
      <div className='mx-auto flex flex-col text-left my-4'>
        ...
        <p className='text-xl'>{file? file?.name: 
        'Custom audio'}</p>
        </div>
      ...
      <div className='flex items-center justify-between gap-4'>
        ...
        <button onClick={handleFormSubmission} className='specialBtn px-3 py-2 rounded-lg text-purple-900 flex items-center gap-2 font-medium'>
          <p>Transcribe</p>
